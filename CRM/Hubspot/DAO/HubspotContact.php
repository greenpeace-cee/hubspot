 ...
 * (GenCodeChecksum:6267449fc418456d84887ce950a770b7)
 */
...
class CRM_Hubspot_DAO_HubspotContact extends CRM_Core_DAO {
  ...
  /**
   * Is this record a non-canonical merge?
   *
   * @var bool|string
   *   (SQL type: tinyint)
   *   Note that values will be retrieved from the database as a string.
    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        ...
        'is_merge' => [
          ...
          'type' => CRM_Utils_Type::T_BOOLEAN,
          'title' => E::ts('Merged?'),
          'description' => E::ts('Is this record a non-canonical merge?'),
          'required' => TRUE,
          'usage' => [
            'import' => FALSE,
            'export' => FALSE,
          ...
          'where' => 'civicrm_hubspot_contact.is_merge',
          'default' => '0',
          'table_name' => 'civicrm_hubspot_contact',
          'entity' => 'HubspotContact',
          'bao' => 'CRM_Hubspot_DAO_HubspotContact',
