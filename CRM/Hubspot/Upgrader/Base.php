 ...
 */
class CRM_Hubspot_Upgrader_Base {

  /**
   * @var CRM_Hubspot_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Hubspot_Upgrader(
        'hubspot',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Hubspot_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Hubspot_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
